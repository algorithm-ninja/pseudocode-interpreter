...
For development, set up a `*.olinfo.it` domain to point to localhost, then load
`*.olinfo.it:8080/index.html` and log in; finally, head to
`*.olinfo.it:8080/ide`.
...
There are two empty spaces in the MIT license you need to fill out: `` and `Luca Versari <veluca93@gmail.com>`.
